...
SIMTIME_POS             = (WIN_WIDTH-ROOM_WIDTH-WIN_BORDER-2*ROOM_BORDER, 95*(WIN_LENGTH//100))  
...
BUTTON_STOP_POS         = ((RATIO_OFFSET_BUTTONS+INITIAL_POSITION_BUTTON)*(WIN_WIDTH//100), 93*(WIN_LENGTH//100))
BUTTON_RELOAD_POS       = ((2*RATIO_OFFSET_BUTTONS+INITIAL_POSITION_BUTTON)*(WIN_WIDTH//100), 93*(WIN_LENGTH//100))
BUTTON_SAVE_POS         = ((3*RATIO_OFFSET_BUTTONS+INITIAL_POSITION_BUTTON)*(WIN_WIDTH//100), 93*(WIN_LENGTH//100))
BUTTON_DEFAULT_POS      = ((4*RATIO_OFFSET_BUTTONS+INITIAL_POSITION_BUTTON)*(WIN_WIDTH//100), 93*(WIN_LENGTH//100))
...
BOX_WIDTH           = WIN_WIDTH - 2*WIN_BORDER - 2*ROOM_BORDER - ROOM_WIDTH # [x axis] width of information gui boxes
...
OFFSET_SUN_MOON_Y       = 35  # [y axis] between weather box position and moon/sun img position
OFFSET_SUN_MOON_X       = 150 # [x axis] between weather box position and moon/sun img position
OFFSET_SUNRISE_SUNSET_Y = 25  # [y axis] between weather box position and sunrise/sunset img position
...
OFFSET_SENSOR_LEVELS_BOX_Y_BOTTOM   = WIN_LENGTH - 345 # [y axis] between top GUI window and position of sesnors box (origin is box bottom)
SENSOR_LEVELS_BOX_LENGTH            = 230              # [y axis] 
SENSOR_LEVELS_BOX_WIDTH             = BOX_WIDTH        # [x axis]
# Availables devices offsets
OFFSET_AVAILABLE_DEVICES        = 20  # [x axis] base offset between two consecutive available devices img
OFFSET_AVAILABLEDEVICES_LINE1   = WIN_LENGTH - 420                   # [y axis] between top GUI window and position of first line of available devices
OFFSET_AVAILABLEDEVICES_LINE2   = OFFSET_AVAILABLEDEVICES_LINE1 - 80 # [y axis] between top GUI window and position of second line of available devices
OFFSET_AVAILABLEDEVICES_LINE3   = OFFSET_AVAILABLEDEVICES_LINE2 - 80 # [y axis] between top GUI window and position of third line of available devices
AVAILABLE_DEVICES_BOX_WIDTH     = BOX_WIDTH # [x axis]
AVAILABLE_DEVICES_BOX_LENGTH    = 3*(OFFSET_AVAILABLEDEVICES_LINE1 - OFFSET_AVAILABLEDEVICES_LINE2) + OFFSET_AVAILABLE_DEVICES # [y axis]
# Devices List offsets
OFFSET_DEVICESLIST_TITLE     = 30 # [y axis] between "Devices in the Room:" title and the first device label
OFFSET_LIST_DEVICE           = 33 # [y axis] between elements in room devices list 
OFFSET_INDIVIDUAL_ADDR_LABEL = 12 # [x axis] between device label and its individual address label
DEVICE_LIST_BOX_WIDTH           = BOX_WIDTH # [x axis]
OFFSET_DEVICELIST_BOX_TOP       = 35        # [y axis] between box top and "Devices in the Room:" title
...
# Special offsets
OFFSET_DIMMER_RATIO     = 5   # [x axis] between end of dimer img and position of dimmer state (%)
...
COLOR_BOX_SIMTIME           = BLUEGREY500_RGBA[:-1]
...
# Weather  box colors
COLOR_BOX_WEATHER           = BLUEGREY500_RGBA[:-1]
...
# Sensors box colors
COLOR_BOX_SENSORS           = BLUEGREY500_RGBA[:-1]
