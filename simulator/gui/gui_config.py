...
ROOM_WIDTH = 1000
ROOM_LENGTH = 800
BOX_BORDER = WIN_BORDER/3

OFFSET_ROOM_LABEL = 40
OFFSET_TITLE = 20 # [y axis] Between Titles and Information (e.g. devices list, brightness/temperature values)
OFFSET_SIMTIME_DATE = 30
OFFSET_STATE_LABEL = 6 # [x & y axis] space between box border and out_state label
OFFSET_SUN_MOON_Y = 35
OFFSET_SUNRISE_SUNSET_Y = 25
OFFSET_SUNRISE_X = 50
OFFSET_SUN_MOON_X = 150
OFFSET_SUNSET_X = 250
OFFSET_CLOUD_WIDTH_RATIO = 0.5
OFFSET_CLOUD_DARK_WIDTH_RATIO = 0
OFFSET_CLOUD_LENGTH_RATIO = 0.5
OFFSET_CLOUD_DARK_LENGTH_RATIO = 0.3
...
TIMEWEATHER_POS = (WIN_BORDER/2, WIN_BORDER/2+ROOM_LENGTH+2*ROOM_BORDER)  #2*(self.__width//100)
SIMTIME_POS = (WIN_WIDTH-ROOM_WIDTH-WIN_BORDER-2*ROOM_BORDER, 95*(WIN_LENGTH//100))  #2*(self.__width//100)
...
SIMTIME_BOX_WIDTH = 320
SIMTIME_BOX_LENGTH = 75
TIMEWEATHER_BOX_WIDTH = WIN_WIDTH - 2*WIN_BORDER - 2*ROOM_BORDER - ROOM_WIDTH 
TIMEWEATHER_BOX_LENGTH = WIN_LENGTH - WIN_BORDER/2 - TIMEWEATHER_POS[1] 
AVAILABLE_DEVICES_BOX_WIDTH = TIMEWEATHER_BOX_WIDTH
AVAILABLE_DEVICES_BOX_LENGTH = 3*(OFFSET_AVAILABLEDEVICES_LINE1 - OFFSET_AVAILABLEDEVICES_LINE2) + OFFSET_AVAILABLE_DEVICES
DEVICE_LIST_BOX_WIDTH = TIMEWEATHER_BOX_WIDTH
OFFSET_SENSOR_LEVELS_BOX_Y_BOTTOM = WIN_LENGTH - 345 ###NOTE top window offset
SENSOR_LEVELS_BOX_LENGTH = 230
SENSOR_LEVELS_BOX_WIDTH = TIMEWEATHER_BOX_WIDTH
