...
dimmer1_config = {"name":"dimmer1", "indiv_addr":[0,0,22], "location":[8,5,1], "group_addresses":['1/1/1']}
# Actuators
led1_config = {"name":"led1", "indiv_addr":[0,0,1], "location":[5,5,1], "group_addresses":['1/1/1'], "max_lumen":800, "state_ratio":100, "beam_angle":180, "state_ratio":100, "effective_lumen":800}
heater1_config = {"name":"heater1", "indiv_addr":[0,0,11], "max_power":400, "location":[11,2,1], "group_addresses":['1/1/1'], "state_ratio":100, "power":400}
ac1_config = {"name":"ac1", "indiv_addr":[0,0,12], "max_power":400, "location":[11,5,1], "group_addresses":['1/1/1'], "state_ratio":100, "power":400}
switch1_config = {"name":"switch1", "indiv_addr":[0,0,44], "location":[8,10,1], "group_addresses":['1/1/1']}
# Sensors
bright1_config = {"name":"brightness1", "indiv_addr":[0,0,5], "location":[10,10,1], "group_addresses":['1/1/1']}
thermometer1_config = {"name":"thermometer1", "indiv_addr":[0,0,33], "location":[8,9,1], "group_addresses":['1/1/1']}
humidity_config = {"name":"humiditysoil1", "indiv_addr":[0,0,34], "location":[8,9,1], "group_addresses":['1/1/1']}
co2sensor1_config = {"name":"co2sensor1", "indiv_addr":[0,0,35], "location":[8,9,2], "group_addresses":['1/1/1']}
airsensor1_config = {"name":"airsensor1", "indiv_addr":[0,0,55], "location":[8,9,3], "group_addresses":['1/1/1']}
presencesensor1_config = {"name":"presencesensor1", "indiv_addr":[0,0,66], "location":[8,2,1], "group_addresses":['1/1/1']}
...
def test_incorrect_device_name():
    ...
    for dev_class in wrong_device_names:
        for wrong_name in wrong_device_names[dev_class]:
            with pytest.raises(SystemExit) as pytest_wrapped_error:
                devices_classes[dev_class](wrong_name, system.IndividualAddress(1,1,1))
            assert pytest_wrapped_error.type == SystemExit
