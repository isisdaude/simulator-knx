...
def test_telegram_from_simulated_1():
    ...
    simulator_t = sim_t.Telegram(0, ia1, ga1, BinaryPayload(True))
    ...
    simulator_t = sim_t.Telegram(0, ia1, ga1, FloatPayload(22.2))
...
def test_telegram_from_simulated_2():
    ...
    simulator_t = sim_t.Telegram(0, ia1, ga1, BinaryPayload(False))
    knx_t = parser.from_simulator_telegram(simulator_t)
    assert str(simulator_t) == str(parser.from_knx_telegram(knx_t))
    ...
    simulator_t = sim_t.Telegram(0, ia1, ga1, FloatPayload(123789.0))
    ...
    simulator_t = sim_t.Telegram(0, ia1, ga1, FloatPayload(1234567.0))
...
def test_telegram_from_simulated_3():
    ...
    simulator_t = sim_t.Telegram(0, ia1, ga1, FloatPayload(1.0))
    ...
    simulator_t = sim_t.Telegram(0, ia1, ga1, FloatPayload(90.0))
